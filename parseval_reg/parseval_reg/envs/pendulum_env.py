...
class ContinualPendulumSequence:
    ...
    def _normalize_obs(self, obs):
        """
        Normalize observation using running mean and variance.
    ...
    # Evaluation
    # ---------------------------------------------------------------------
    def evaluate_agent(self, agent, num_eval_episodes=10, render=False, mode="current"):
        """
        ...
        results["episodic_returns"] = all_task_returns[f'Task{task_indices[0]+1}']['returns']
